...
public class PanelZuordnung extends JPanel{
	...
	public PanelZuordnung()
	{
		...
		JLabel lblZuordnungHeader = new JLabel("<html>Bitte fassen Sie die Einzelergebnisse der Analyse in ein Kennzeichen <p/> zusammen, welches mit dem Artikel gespeichert wird.</html>");
